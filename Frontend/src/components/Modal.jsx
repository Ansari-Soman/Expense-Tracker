...
const Modal = ({ children, isOpen, onClose, title }) => {
  if (!isOpen) return;
  return (
    <div className="fixed top-0 bottom-0 right-0  left-0 flex justify-center items-center w-full h-[calc(100%-1remm)] max-h-full overflow-y-auto overflow-x-hidden bg-black/20 bg-opacity-50">
